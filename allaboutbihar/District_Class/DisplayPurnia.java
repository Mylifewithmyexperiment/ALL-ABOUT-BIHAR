...
public class DisplayPurnia extends AppCompatActivity {
	...
	String[] data = {
			...
			"Total Population\t- 3264619",

			"Area\t-  3228 sq.km",

			"Population Density\t- 787 ",

			"Sex Ratio\t- 921	",

			"Total Literacy\t- 51.08 %",

	};
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_display_purnia);
