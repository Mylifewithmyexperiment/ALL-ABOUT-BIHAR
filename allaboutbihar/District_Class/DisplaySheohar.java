...
public class DisplaySheohar extends AppCompatActivity {
	...
	String[] data = {
			...
			"Total Population\t-656916 ",

			"Area\t-  443 sq.km",

			"Population Density\t-  1161 ",

			"Sex Ratio\t-893	",

			"Total Literacy\t- 53.78 %",

	};
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_display_sheohar);
