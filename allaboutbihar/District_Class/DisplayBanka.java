...
public class DisplayBanka extends AppCompatActivity {

	GridView lv2;
	Toolbar toolbar;
	String[] data = { "Headquarter\t- Banka",

					  "Area\t-  	3018 sq.km",

					  "Total Population\t-2034763  ",

					  "Sex Ratio\t-907",

					  "Total Literacy\t- 58.17 %",

					  "Population Density\t-  533 ", };
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_display_banka);
