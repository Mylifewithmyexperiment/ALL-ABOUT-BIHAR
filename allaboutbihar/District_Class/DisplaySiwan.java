...
public class DisplaySiwan extends AppCompatActivity {
	...
	String[] data = {
			...
			"Total Population\t-3330464 ",

			"Area\t- 2219  sq.km",

			"Population Density\t-1221  ",

			"Sex Ratio\t- 988	",

			"Total Literacy\t- 69.45 %",
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_display_siwan);
