...
public class DisplayPashchimChamparan extends AppCompatActivity {


	GridView lv2;
	Toolbar toolbar;
	String[] data = { "Headquarter\t- Bettiah",

					  "Total Population\t-3935042",
					  ...
					  "Total Literacy\t-55.70 % ",

					  };
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_display_pashchim);
