...
public class DisplaySupaul extends AppCompatActivity {
	...
	String[] data = {
			...
			"Total Population\t-2229076 ",

			"Area\t- 2410  sq.km",

			"Population Density\t-724  ",

			"Sex Ratio\t- 929	",

			"Total Literacy\t- 57.67 %",
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_display_supaul);
