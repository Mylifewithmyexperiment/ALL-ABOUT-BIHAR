...
public class DisplaySitamarhi extends AppCompatActivity {

	GridView lv2;
	Toolbar toolbar;
	String[] data = {

			"Headquarter\t- Sitamarhi",

			"Total Population\t- 3423574",

			"Area\t-  2199 sq.km",

			"Population Density\t-  1214",

			"Sex Ratio\t- 899		",

			"Total Literacy\t- 52.05 %",
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_display_sitamarhi);
