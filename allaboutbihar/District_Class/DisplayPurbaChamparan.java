...
public class DisplayPurbaChamparan extends AppCompatActivity {
	...
	Toolbar toolbar;
	String[] data = {
			"Headquarter\t- Motihari",

			"Total Population\t- 5099371",

			"Area\t-3969   sq.km",

			"Population Density\t- 991 ",

			"Sex Ratio\t- 902	",

			"Total Literacy\t- 55.79 %",
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_display_purba_champaran);
