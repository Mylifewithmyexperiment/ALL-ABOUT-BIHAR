...
public class DisplayDarbhanga extends AppCompatActivity {


	GridView lv2;
	Toolbar toolbar;
	String[] data = { "Headquarter\t-Darbhanga ",

					  "Total Population\t-3937385 ",

					  "Area\t-  2278 sq.km",

					  "Population Density\t-  1442",

					  "Sex Ratio\t- 911	",

					  "Total Literacy\t- 56.56 %",
					  };
