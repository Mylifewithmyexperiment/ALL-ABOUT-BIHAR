...
public class DisplayMadhubani extends AppCompatActivity {


	GridView lv2;
	Toolbar toolbar;
	String[] data = { "Headquarter\t- Madhubani",

					  "Total Population\t- 4487379",

					  "Area\t- 3501  sq.km",

					  "Population Density\t-  1020",

					  "Sex Ratio\t- 926	",

					  "Total Literacy\t-58.62 % ",
					  };
