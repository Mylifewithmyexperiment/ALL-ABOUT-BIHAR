...
public class DisplayBegusarai extends AppCompatActivity {


	GridView lv2;
	Toolbar toolbar;

	String[] data = { "Headquarter\t- Begusarai",

					  "Total Population\t- 2970541",

					  "Area\t-   1917sq.km",

					  "Population Density\t- 1222",

					  "Sex Ratio\t- 895",
					  "Total Literacy\t- 63.87 %",};
	@Override
