...
public class DisplaySamastipur extends AppCompatActivity {
	...
	String[] data = {
			...
			"Total Population\t-4261566 ",

			"Area\t-   2905sq.km",

			"Population Density\t-1175  ",

			"Sex Ratio\t-911	 ",

			"Total Literacy\t- 61.86 %",
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_display_samastipur);
