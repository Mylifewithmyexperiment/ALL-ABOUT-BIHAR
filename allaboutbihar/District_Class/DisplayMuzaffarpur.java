...
public class DisplayMuzaffarpur extends AppCompatActivity {


	GridView lv2;
	Toolbar toolbar;
	String[] data = { "Headquarter\t-Muzaffarpur ",

					  "Total Population\t- 4801062",

					  "Area\t-  3173 sq.km",

					  "Population Density\t-  1180",

					  "Sex Ratio\t- 900	",

					  "Total Literacy\t-63.43 % ",
					  };
	@Override
