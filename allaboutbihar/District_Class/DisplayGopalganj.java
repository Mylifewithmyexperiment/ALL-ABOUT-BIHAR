...
public class DisplayGopalganj extends AppCompatActivity {


	GridView lv2;
	Toolbar toolbar;
	String[] data = { "Headquarter\t-Gopalganj ",

					  "Total Population\t- 2562012",

					  "Area\t-  2033 sq.km",

					  "Population Density\t- 1057 ",

					  "Sex Ratio\t-1021	 ",

					  "Total Literacy\t- 65.47 %",
