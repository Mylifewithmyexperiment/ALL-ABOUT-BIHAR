...
public class DisplayVaishali extends AppCompatActivity {
	...
	String[] data = {
			...
			"Total Population\t-3495021 ",

			"Area\t-   2036sq.km",

			"Population Density\t- 1332 ",

			"Sex Ratio\t- 895	 ",

			"Total Literacy\t- 66.60 %",

	};
	@Override
	protected void onCreate(Bundle a) {
		super.onCreate(a);
		setContentView(R.layout.activity_display_vaishali);
