...
public class DisplaySheikhpura extends AppCompatActivity {
	...
	String[] data = {
			...
			"Headquarter\t- Sheikhpura",

			"Total Population\t- 634927",
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_display_sheikhpura);
