...
public class DisplayNawada extends AppCompatActivity {

	GridView lv2;
	Toolbar toolbar;
	String[] data = { "Headquarter\t- Nawada",

					  "Total Population\t- 2219146",
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_display_nawada);
	...
	class MyAdapter extends ArrayAdapter {
		...
		public MyAdapter(DisplayNawada c, String[] sem1) {
