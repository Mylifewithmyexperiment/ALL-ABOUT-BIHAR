...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
	{
		...
		MobileAds.initialize(this, "ca-app-pub-5278704802151871~1584002421");
...
//ca-app-pub-5278704802151871/3653804946
		...
		{
			case 0:
				tv2.setText("When was Bihar established?\n" +
						"15 November 2000.");
				break;
			case 1:
				tv2.setText("How many Districts are their in Bihar?\n" +
						"\t24 Districts.");
				break;
			case 2:
				tv2.setText("\"Which is the Largest District of Bihar?\n" +
						"\t\t- Jamshedpur");
				break;
			case 3:
			...
			case 5:
				...
				break;
			case 6:
				tv2.setText("What is the capital of Bihar?\n" +
						"Ranchi ");
				break;
			case 7:
				tv2.setText("In which part of Bihar is the minimum temperature in winter " +
						"found?\n" +
						"  Neterhat plateau");
				break;
			case 8:
				tv2.setText("In which part of Bihar is maximum rainfall being recorded ?\n" +
						 "Neterhat plateau ");
				break;
			case 9:
 ...
 * App ID: ca-app-pub-5278704802151871~2335007935
 ...
 banner ad unit id "ca-app-pub-5278704802151871/3653804946"
interstitial ad unit id  ca-app-pub-5278704802151871/1122469080
 *
 *
 *
 */
/**
 ...
 ALL ABOUT BIHAR
 Android
 App ID: ca-app-pub-5278704802151871~1584002421



banner ap unit id
 ca-app-pub-5278704802151871/8570005183


interstitial app unit id
 ca-app-pub-5278704802151871/7088089475
